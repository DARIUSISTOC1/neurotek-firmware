...
Note that mentioned below are only a few of our staple additions to the firmware. For a full list check [down here](https://github.com/DARIUSISTOC1/neurotek-firmware)

<br>
<h2 align="center">Neurotek Settings</h2>
...
[![Stargazers over time](https://starchart.cc/DARIUSISTOC1/neurotek-firmware.svg?variant=adaptive)](
...
> **[Buy me a coffee](https://buymeacoffee.com/DARIUSISTOC1)**: One-off or Recurring, No signup required

> **[PayPal](https://paypal.me/DariusIstoc1?locale.x=fr_FR&country.x=FR)**: One-off, Signup required
